...
| --- | --- | --- |
| `index.html` | the site — hero, broadsheet, inline SVG artifacts | mirrored |
...
| `src/scripts/` (6 js) | shader + adapter (locked material), blob lifecycle, hero, broadsheet behaviours, craft study | mirrored |
...
Frozen as **v2.0.0**, 2026-07-06. Site: <https://atheric.eu> · Works:
